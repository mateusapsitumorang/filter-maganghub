...
import { MapPin, GraduationCap, Users, Briefcase, Search, Menu, X, ChevronLeft, ChevronRight } from 'lucide-react';
...
function App() {
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [currentPage, daerah, jurusan, search, sortByKuota, sortByWaktu]);
